...
if ( !class_exists( 'WC_Warranties_And_Returns' ) ) :
	...
	class WC_Warranties_And_Returns {
		...
		function war_install() {
			...
			if ( !get_option( 'war_settings_page' ) ) {
				...
				$curr_page = array(
					'post_title' => esc_html__( 'Request Warranty', 'woocommerce-warranties-and-returns' ),
		...
		function activate() {
			if ( !class_exists( 'WooCommerce' ) ) {
				...
				wp_die( __( 'This plugin requires WooCommerce. Download it from WooCommerce official website', 'woocommerce-warranties-and-returns' ) . ' &rarr; https://woocommerce.com' );
				exit;
			}
		...
		function init_plugin() {
			...
			$curr_args = array(
				...
				'labels' => array(
					'name'              => esc_html__( 'Warranty Presets', 'woocommerce-warranties-and-returns' ),
					'singular_name'     => esc_html__( 'Warranty Preset', 'woocommerce-warranties-and-returns' ),
					'search_items'      => esc_html__( 'Search Warranty Presets', 'woocommerce-warranties-and-returns' ),
					'all_items'         => esc_html__( 'All Warranty Presets', 'woocommerce-warranties-and-returns' ),
					'parent_item'       => esc_html__( 'Parent Warranty Preset', 'woocommerce-warranties-and-returns' ),
					'parent_item_colon' => esc_html__( 'Parent Warranty Preset:', 'woocommerce-warranties-and-returns' ),
					'edit_item'         => esc_html__( 'Edit Warranty Preset', 'woocommerce-warranties-and-returns' ),
					'update_item'       => esc_html__( 'Update Warranty Preset', 'woocommerce-warranties-and-returns' ),
					'add_new_item'      => esc_html__( 'Add New Warranty Preset', 'woocommerce-warranties-and-returns' ),
					'new_item_name'     => esc_html__( 'New Warranty Name Preset', 'woocommerce-warranties-and-returns' )
				),
				'show_ui'               => true,
			...
			$curr_args = array(
				...
				'labels' => array(
					...
					'singular_name'     => esc_html__( 'Warranty Status', 'woocommerce-warranties-and-returns' ),
					'search_items'      => esc_html__( 'Search Warranty', 'woocommerce-warranties-and-returns' ),
					'all_items'         => esc_html__( 'All Warranty', 'woocommerce-warranties-and-returns' ),
					'parent_item'       => esc_html__( 'Parent Warranty', 'woocommerce-warranties-and-returns' ),
					'parent_item_colon' => esc_html__( 'Parent Warranty:', 'woocommerce-warranties-and-returns' ),
					'edit_item'         => esc_html__( 'Edit Warranty', 'woocommerce-warranties-and-returns' ),
					'update_item'       => esc_html__( 'Update Warranty', 'woocommerce-warranties-and-returns' ),
					'add_new_item'      => esc_html__( 'Add New Warranty', 'woocommerce-warranties-and-returns' ),
					'new_item_name'     => esc_html__( 'New Warranty Name', 'woocommerce-warranties-and-returns' )
				),
				'show_ui'               => false,
				'show_in_nav_menus'     => true,
				'query_var'             => true,
			...
			$curr_args = array(
				'label'                 => esc_html__( 'Warranties and Returns', 'woocommerce-warranties-and-returns' ),
				'labels'                => array(
					'name'              => esc_html__( 'Warranty and Returns Requests', 'woocommerce-warranties-and-returns' ),
					'singular_name'     => esc_html__( 'Warranty and Return Request', 'woocommerce-warranties-and-returns' ),
					'all_items'         => esc_html__( 'All Requests', 'woocommerce-warranties-and-returns' ),
					'menu_name'         => esc_html__( 'Warranties and Returns', 'woocommerce-warranties-and-returns' ),
					'not_found'         => esc_html__( 'No requests found', 'woocommerce-warranties-and-returns' ),
					'edit_item'         => esc_html__( 'Edit Request', 'woocommerce-warranties-and-returns' ),
					'add_new_item'      => esc_html__( 'Create a Request', 'woocommerce-warranties-and-returns' ),
					'new_item_name'     => esc_html__( 'Create a Request', 'woocommerce-warranties-and-returns' ),
					'parent_item_colon' => esc_html__( 'Parent Request', 'woocommerce-warranties-and-returns' ),
					'view_item'         => esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ),
					'search_items'      => esc_html__( 'Search Requests', 'woocommerce-warranties-and-returns' )
				),
				'public'                => true,
				...
				var wcwar_metabox = "<div class=\"wcwar_metabox\">\
					...
					<div class=\"options_group grouping\" data-group=\"included_warranty\">\
						<p class=\"form-field wcwar_qp_price\">\
							<label for=\"wcwar_qp_price\">' . esc_html__( 'Additional warranty price', 'woocommerce-warranties-and-returns' ) . '</label>\
							<input type=\"number\" class=\"option short wc_input_price\" name=\"wcwar_qp_price_single[]\" value=\"\" placeholder=\"\" step=\"any\">\
							<em>' . esc_html__( 'Enter additional price for this warranty.', 'woocommerce-warranties-and-returns' ) . '</em>\
						</p>\
						<p class=\"form-field wcwar_qp_type\">\
							<label for=\"wcwar_qp_type\">' . esc_html__( 'Warranty period type', 'woocommerce-warranties-and-returns' ) . '</label>\
							<select name=\"wcwar_qp_type_single[]\" class=\"option select short\">\
								<option value=\"\">' . esc_html__( 'Not selected', 'woocommerce-warranties-and-returns' ) . '</option>\
								<option value=\"days\">' . esc_html__( 'Days', 'woocommerce-warranties-and-returns' ) . '</option>\
								<option value=\"weeks\">' . esc_html__( 'Weeks', 'woocommerce-warranties-and-returns' ) . '</option>\
								<option value=\"months\">' . esc_html__( 'Months', 'woocommerce-warranties-and-returns' ) . '</option>\
								<option value=\"years\">' . esc_html__( 'Years', 'woocommerce-warranties-and-returns' ) . '</option>\
								<option value=\"lifetime\">' . esc_html__( 'Lifetime', 'woocommerce-warranties-and-returns' ) . '</option>\
							</select>\
							<em>' . esc_html__( 'Select warranty period type.', 'woocommerce-warranties-and-returns' ) . '</em>\
						</p>\
						<p class=\"form-field wcwar_qp_period\">\
							<label for=\"wcwar_qp_period\">' . esc_html__( 'Warranty period', 'woocommerce-warranties-and-returns' ) . '</label>\
							<input type=\"number\" class=\"option short\" name=\"wcwar_qp_period_single[]\" value=\"\" placeholder=\"\" step=\"any\">\
							<em>' . esc_html__( 'Enter warranty period.', 'woocommerce-warranties-and-returns' ) . '</em>\
						</p>\
						<p class=\"form-field wcwar_qp_desc\">\
							<label for=\"wcwar_qp_desc\">' . esc_html__( 'Warranty description (optional)', 'woocommerce-warranties-and-returns' ) . '</label>\
							<textarea class=\"option short\" name=\"wcwar_qp_desc_single[]\" placeholder=\"\" step=\"any\"></textarea>\
							<em>' . esc_html__( 'Enter warranty description.', 'woocommerce-warranties-and-returns' ) . '</em>\
						</p>\
						<p class=\"form-field wcwar_qp_thumb\">\
							<span class=\"thumb_preview\"></span>\
							<label for=\"wcwar_qp_thumb\">' . esc_html__( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ) . '</label>\
							<input type=\"hidden\" class=\"option short\" name=\"wcwar_qp_thumb_single[]\" value=\"\" placeholder=\"\" step=\"any\">\
							<button type=\"button\" class=\"option button add_wcwar_qp_thumb\">' . esc_html__( 'Add warranty thumbnail', 'woocommerce-warranties-and-returns' ) . '</button>\
						</p>\
					</div>\
				</div>";
		...
		<div id="wcwar_tab" class="panel woocommerce_options_panel">
			...
			<div class="options_group grouping basic">
				<p class="form-field wcwar_type">
					<label for="wcwar_type"><?php esc_html_e( 'Select warranty type', 'woocommerce-warranties-and-returns' ); ?></label>
					<select id="wcwar_type" name="wcwar_type_single" class="option select short">
						<option value="no_warranty" <?php if ( $curr_warranty['type'] == 'no_warranty') echo 'selected'; ?>><?php esc_html_e( 'No warranty', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="preset_warranty" <?php if ( $curr_warranty['type'] == 'preset_warranty') echo 'selected'; ?>><?php esc_html_e( 'Preset warranty', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="quick_warranty" <?php if ( $curr_warranty['type'] == 'quick_warranty') echo 'selected'; ?>><?php esc_html_e( 'Quick warranty', 'woocommerce-warranties-and-returns' ); ?></option>
					</select>
					<em><?php esc_html_e( 'Select preset warranty or add quick product warranty.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
			</div>
			...
			<div class="options_group grouping preset" data-group="preset_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
				<p class="form-field wcwar_preset">
					<label for="wcwar_preset"><?php esc_html_e( 'Select warranty preset', 'woocommerce-warranties-and-returns' ); ?></label>
					<select id="wcwar_preset" name="wcwar_preset_single" class="option select short"<?php echo ( !empty( $curr_disable ) ? ' disabled="' . esc_attr( $curr_disable ) . '"' : '' ); ?>>
						<option value="" <?php if (isset( $curr_warranty['preset'] ) && $curr_warranty['preset'] == '') echo 'selected'; ?>><?php esc_html_e( 'Not selected', 'woocommerce-warranties-and-returns' ); ?></option>
					<?php
					...
					<em><?php esc_html_e( 'Select warranty preset to use with the current product. Warranty presets can be set in Products &gt; Warranty Presets.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
			</div>
			...
			<div class="options_group grouping type" data-group="quick_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
				<p class="form-field wcwar_q_type">
					<label for="wcwar_q_type"><?php esc_html_e( 'Select quick warranty type', 'woocommerce-warranties-and-returns' ); ?></label>
					<select id="wcwar_q_type" name="wcwar_q_type_single" class="option select short"<?php echo ( !empty( $curr_disable ) ? ' disabled="' . esc_attr( $curr_disable ) . '"' : '' ); ?>>
						<option value=""><?php esc_html_e( 'Not selected', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="included_warranty" <?php if (isset( $curr_warranty['quick'] ) && $curr_warranty['quick'] == 'included_warranty') echo 'selected'; ?>><?php esc_html_e( 'Included warranty', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="paid_warranty" <?php if (isset( $curr_warranty['quick'] ) && $curr_warranty['quick'] == 'paid_warranty') echo 'selected'; ?>><?php esc_html_e( 'Paid warranty', 'woocommerce-warranties-and-returns' ); ?></option>
					</select>
					<em><?php esc_html_e( 'Warranties can be included or paid as an add-on. Choose your warranty type.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
			</div>
			...
			<div class="options_group grouping" data-group="included_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
				<p class="form-field wcwar_qi_type">
					<label for="wcwar_qi_type"><?php esc_html_e( 'Warranty period type', 'woocommerce-warranties-and-returns' ); ?></label>
					<select id="wcwar_qi_type" name="wcwar_qi_type_single" class="option select short"<?php echo ( !empty( $curr_disable ) ? ' disabled="' . esc_attr( $curr_disable ) . '"' : '' ); ?>>
						...
						?>
						<option value=""><?php esc_html_e( 'Not selected', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="days" <?php if (isset( $curr_options['type'] ) && $curr_options['type'] == 'days') echo 'selected'; ?>><?php esc_html_e( 'Days', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="weeks" <?php if (isset( $curr_options['type'] ) && $curr_options['type'] == 'weeks') echo 'selected'; ?>><?php esc_html_e( 'Weeks', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="months" <?php if (isset( $curr_options['type'] ) && $curr_options['type'] == 'months') echo 'selected'; ?>><?php esc_html_e( 'Months', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="years" <?php if (isset( $curr_options['type'] ) && $curr_options['type'] == 'years') echo 'selected'; ?>><?php esc_html_e( 'Years', 'woocommerce-warranties-and-returns' ); ?></option>
						<option value="lifetime" <?php if (isset( $curr_options['type'] ) && $curr_options['type'] == 'lifetime') echo 'selected'; ?>><?php esc_html_e( 'Lifetime', 'woocommerce-warranties-and-returns' ); ?></option>
					</select>
					<em><?php esc_html_e( 'Select warranty period type.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
				<p class="form-field wcwar_qi_period">
					<label for="wcwar_qi_period"><?php esc_html_e( 'Warranty period', 'woocommerce-warranties-and-returns' ); ?></label>
					...
					<em><?php esc_html_e( 'Enter warranty period.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
				<p class="form-field wcwar_qi_desc">
					<label for="wcwar_qi_desc"><?php esc_html_e( 'Warranty description (optional)', 'woocommerce-warranties-and-returns' ); ?></label>
					...
					<em><?php esc_html_e( 'Enter warranty description.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
				<p class="form-field wcwar_qi_thumb">
					<span class="thumb_preview"><?php if (isset( $curr_options['thumb'] ) && $curr_options['thumb'] !== '') echo '<img width="64" height="auto" src="' . esc_url( $curr_options['thumb'] ) . '" alt="' .esc_html__( 'Thumbnail preview', 'woocommerce-warranties-and-returns' ) . '" />'; ?></span>
					<label for="wcwar_qi_thumb"><?php esc_html_e( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ); ?></label>
					...
					<button type="button" class="option button add_wcwar_qi_thumb"<?php echo ( !empty( $curr_disable ) ? ' disabled="' . esc_attr( $curr_disable ) . '"' : '' ); ?>><?php esc_html_e( 'Add warranty thumbnail', 'woocommerce-warranties-and-returns' ); ?></button>
				</p>
			</div>
			...
			<div class="options_group grouping" data-group="paid_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
				<p class="form-field wcwar_qp_without_single">
					<label for="wcwar_qp_without_single"><?php esc_html_e( 'Add No Warranty option', 'woocommerce-warranties-and-returns' ); ?></label>
					...
					<em><?php esc_html_e( 'To enable product purchases without a paid warranty check this option.', 'woocommerce-warranties-and-returns' ); ?></em>
				</p>
			</div>
			...
			<div class="options_group grouping" data-group="paid_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
				...
				<?php
					...
					?>
						<div class="wcwar_metabox">
							...
							<div class="options_group grouping" data-group="included_warranty">
								<p class="form-field wcwar_qp_price">
									<label for="wcwar_qp_price"><?php esc_html_e( 'Additional warranty price', 'woocommerce-warranties-and-returns' ); ?></label>
									...
									<em><?php esc_html_e( 'Enter additional price for this warranty.', 'woocommerce-warranties-and-returns' ); ?></em>
								</p>
								<p class="form-field wcwar_qp_type">
									<label for="wcwar_qp_type"><?php esc_html_e( 'Warranty period type', 'woocommerce-warranties-and-returns' ); ?></label>
									<select name="wcwar_qp_type_single[]" class="option select short">
										<option value=""><?php esc_html_e( 'Not selected', 'woocommerce-warranties-and-returns' ); ?></option>
										<option value="days" <?php if (isset( $warranty['type'] ) && $warranty['type'] == 'days') echo 'selected'; ?>><?php esc_html_e( 'Days', 'woocommerce-warranties-and-returns' ); ?></option>
										<option value="weeks" <?php if (isset( $warranty['type'] ) && $warranty['type'] == 'weeks') echo 'selected'; ?>><?php esc_html_e( 'Weeks', 'woocommerce-warranties-and-returns' ); ?></option>
										<option value="months" <?php if (isset( $warranty['type'] ) && $warranty['type'] == 'months') echo 'selected'; ?>><?php esc_html_e( 'Months', 'woocommerce-warranties-and-returns' ); ?></option>
										<option value="years" <?php if (isset( $warranty['type'] ) && $warranty['type'] == 'years') echo 'selected'; ?>><?php esc_html_e( 'Years', 'woocommerce-warranties-and-returns' ); ?></option>
										<option value="lifetime" <?php if (isset( $warranty['type'] ) && $warranty['type'] == 'lifetime') echo 'selected'; ?>><?php esc_html_e( 'Lifetime', 'woocommerce-warranties-and-returns' ); ?></option>
									</select>
									<em><?php esc_html_e( 'Select warranty period type.', 'woocommerce-warranties-and-returns' ); ?></em>
								</p>
								<p class="form-field wcwar_qp_period">
									<label for="wcwar_qp_period"><?php esc_html_e( 'Warranty period', 'woocommerce-warranties-and-returns' ); ?></label>
								...
								<p class="form-field wcwar_qp_desc">
									<label for="wcwar_qp_desc"><?php esc_html_e( 'Warranty description (optional)', 'woocommerce-warranties-and-returns' ); ?></label>
								...
								<p class="form-field wcwar_qp_thumb">
									<span class="thumb_preview"><?php if (isset( $warranty['thumb'] ) && $warranty['thumb'] !== '') echo '<img width="64" height="auto" src="' . esc_url( $warranty['thumb'] ) . '" alt="' . esc_attr__( 'Thumbnail preview', 'woocommerce-warranties-and-returns' ) . '" />'; ?></span>
									<label for="wcwar_qp_thumb"><?php esc_html_e( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ); ?></label>
									...
									<button type="button" class="option button add_wcwar_qp_thumb"><?php esc_html_e( 'Add warranty thumbnail', 'woocommerce-warranties-and-returns' ); ?></button>
								</p>
							</div>
						</div>
					<?php
				...
				<p class="toolbar">
					<button type="button" class="option button button-primary add_paid_warranty"<?php echo ( !empty( $curr_disable ) ? ' disabled="' . esc_attr( $curr_disable ) . '"' : '' ); ?>><?php esc_html_e( 'Add paid warranty', 'woocommerce-warranties-and-returns' ); ?></button>
				</p>
			</div>
		...
		?>
			...
			<?php
				woocommerce_wp_select(
					array(
						'id'          => 'wcwar_type[' . $loop . ']',
						'label'       => esc_html__( 'Select warranty type', 'woocommerce-warranties-and-returns' ),
						'description' => esc_html__( 'Select preset warranty or add quick product warranty.', 'woocommerce-warranties-and-returns' ),
						'value'       => esc_attr( $curr_warranty['type'] ),
						'class'       => 'wcwar_type option select short',
						'wrapper_class' => 'form-row form-row-first',
						'options' => array(
							'no_warranty'   => esc_html__( 'No warranty', 'woocommerce-warranties-and-returns' ),
							'preset_warranty'   => esc_html__( 'Preset warranty', 'woocommerce-warranties-and-returns' ),
							'quick_warranty' => esc_html__( 'Quick warranty', 'woocommerce-warranties-and-returns' )
						)
					)
				);
			?>
			...
			<?php
				...
				$presets = get_terms( 'wcwar_warranty_pre', array('hide_empty' => false) );
				$ready_presets = array(
					'' => esc_html__( 'Not selected', 'woocommerce-warranties-and-returns' )
				);
			...
			<?php
				woocommerce_wp_select(
					array(
						...
						'label'       => esc_html__( 'Select warranty preset', 'woocommerce-warranties-and-returns' ),
						'description' => esc_html__( 'Select warranty preset to use with the current product. Warranty presets can be set in Products &gt; Warranty Presets.', 'woocommerce-warranties-and-returns' ),
			...
			<?php
				woocommerce_wp_select(
					array(
						...
						'label'       => esc_html__( 'Select quick warranty type', 'woocommerce-warranties-and-returns' ),
						'description' => esc_html__( 'Warranties can be included or paid as an add-on. Choose your warranty type.', 'woocommerce-warranties-and-returns' ),
						...
						'options' => array(
							'' => esc_html__( 'Not selected', 'woocommerce-warranties-and-returns' ),
							'included_warranty' => esc_html__( 'Included warranty', 'woocommerce-warranties-and-returns' ),
							'paid_warranty' => esc_html__( 'Paid warranty', 'woocommerce-warranties-and-returns' )
						)
					)
				);
			?>
			...
			<?php
				woocommerce_wp_select(
					array(
						...
						'label'       => esc_html__( 'Warranty period type', 'woocommerce-warranties-and-returns' ),
						'description' => esc_html__( 'Select warranty period type.', 'woocommerce-warranties-and-returns' ),
						...
						'options' => array(
							'' => esc_html__( 'Not selected', 'woocommerce-warranties-and-returns' ),
							'days' => esc_html__( 'Days', 'woocommerce-warranties-and-returns' ),
							'weeks' => esc_html__( 'Weeks', 'woocommerce-warranties-and-returns' ),
							'months' => esc_html__( 'Months', 'woocommerce-warranties-and-returns' ),
							'years' => esc_html__( 'Years', 'woocommerce-warranties-and-returns' ),
							'lifetime' => esc_html__( 'Lifetime', 'woocommerce-warranties-and-returns' )
						)
					)
				);
				...
				woocommerce_wp_text_input(
					array( 
						...
						'label'       => esc_html__( 'Warranty period', 'woocommerce-warranties-and-returns' ),
						'description' => esc_html__( 'Enter warranty period.', 'woocommerce-warranties-and-returns' ),
				...
				woocommerce_wp_textarea_input(
					array( 
						...
						'label'       => esc_html__( 'Warranty description (optional)', 'woocommerce-warranties-and-returns' ),
						'placeholder' => '',
						'description' => esc_html__( 'Enter warranty description.', 'woocommerce-warranties-and-returns' ),
			...
			?>
				<span class="thumb_preview"><?php echo isset( $curr_options['thumb'] ) && $curr_options['thumb'] !== '' ? '<img width="64" height="auto" src="' . esc_url( $curr_options['thumb'] ) . '" alt="' . esc_attr__( 'Thumbnail preview', 'woocommerce-warranties-and-returns' ) . '" />' : '<img width="64" height="auto" src="' . self::$url_path . 'assets/images/no_image.gif" alt="' . esc_attr__( 'No image', 'woocommerce-warranties-and-returns' ) . '" />'; ?></span>
				<button type="button" class="option button add_wcwar_qi_thumb"<?php echo !empty( $curr_disable ) ? ' disabled="disabled"' : ''; ?>><?php esc_html_e( 'Add warranty thumbnail', 'woocommerce-warranties-and-returns' ); ?></button>
			<?php

				woocommerce_wp_hidden_input(
					array(
						'id'          => 'wcwar_qi_thumb[' .  $loop . ']',
						'label'       => esc_html__( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ),
						'placeholder' => '',
						'description' => esc_html__( 'Add a warranty thumbnail.', 'woocommerce-warranties-and-returns' ),
			...
			?>
				...
				<?php
					woocommerce_wp_checkbox(
						array(
							...
							'label'         => esc_html__( 'Add No Warranty option', 'woocommerce-warranties-and-returns' ),
							'description'   => esc_html__( 'To enable product purchases without a paid warranty check this option.', 'woocommerce-warranties-and-returns' ),
				...
				?>
							...
							?>
								<div class="wcwar_metabox">
									...
									<div class="options_group grouping" data-group="included_warranty">
										...
										<p class="form-field wcwar_qp_thumb">
											<span class="thumb_preview"><?php if (isset( $warranty['thumb'] ) && $warranty['thumb'] !== '') echo '<img width="64" height="auto" src="' . esc_url( $warranty['thumb'] ) . '" alt="' . esc_html__( 'Thumbnail preview', 'woocommerce-warranties-and-returns' ) . '" />'; ?></span>
											<label for="wcwar_qp_thumb"><?php esc_html_e( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ); ?></label>
					...
					<p class="toolbar">
						<button type="button" class="option button button-primary add_paid_warranty"<?php echo !empty( $curr_disable ) ? ' disabled="disabled"' : ''; ?>><?php esc_html_e( 'Add paid warranty', 'woocommerce-warranties-and-returns' ); ?></button>
					</p>
				</div>
			</div>
		<?php
		...
		?>
			<tr class="panel woocommerce_variation_panel wcwar_tab">
				...
				<td class="options_group grouping basic">
					<h3><?php esc_html_e( 'Item Warranties', 'woocommerce-warranties-and-returns' ); ?></h3>
					<p class="form-field wcwar_type">
						<label for="wcwar_type"><?php esc_html_e( 'Select warranty type', 'woocommerce-warranties-and-returns' ); ?></label>
				...
				<td class="options_group grouping" data-group="included_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
					...
					<p class="form-field wcwar_qi_thumb">
						<span class="thumb_preview"><?php if (isset( $curr_options['thumb'] ) && $curr_options['thumb'] !== '') echo '<img width="64" height="auto" src="' . esc_url( $curr_options['thumb'] ) . '" alt="' .esc_attr__( 'Thumbnail preview', 'woocommerce-warranties-and-returns' ) . '" />'; ?></span>
						<label for="wcwar_qi_thumb"><?php esc_html_e( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ); ?></label>
				...
				<td class="options_group grouping" data-group="paid_warranty"<?php echo !empty( $curr_disable ) ? ' style="display:none;"' : ''; ?>>
					<p class="form-field wcwar_qp_without">
						<label for="wcwar_qp_without"><?php esc_html_e( 'Add No Warranty option', 'woocommerce-warranties-and-returns' ); ?></label>
	...
	?>
				...
				var wcwar_metabox = "<div class=\"wcwar_metabox\">\
							...
							<div class=\"options_group grouping\" data-group=\"included_warranty\">\
								...
								<p class=\"form-field wcwar_qp_type\">\
									...
									<select name=\"wcwar_qp_type[]\" class=\"option select short\">\
										<option value=\"\"><?php  esc_html_e( 'Not selected', 'woocommerce-warranties-and-returns' ); ?></option>\
										<option value=\"days\"><?php  esc_html_e( 'Days', 'woocommerce-warranties-and-returns' ); ?></option>\
										<option value=\"weeks\"><?php  esc_html_e( 'Weeks', 'woocommerce-warranties-and-returns' ); ?></option>\
										<option value=\"months\"><?php  esc_html_e( 'Months', 'woocommerce-warranties-and-returns' ); ?></option>\
										<option value=\"years\"><?php  esc_html_e( 'Years', 'woocommerce-warranties-and-returns' ); ?></option>\
										<option value=\"lifetime\"><?php  esc_html_e( 'Lifetime', 'woocommerce-warranties-and-returns' ); ?></option>\
									</select>\
									<em><?php esc_html_e( 'Select warranty period type.', 'woocommerce-warranties-and-returns' ); ?></em>\
								</p>\
								<p class=\"form-field wcwar_qp_period\">\
								...
								<p class=\"form-field wcwar_qp_desc\">\
									<label for=\"wcwar_qp_desc\"><?php  esc_html_e( 'Warranty description (optional)', 'woocommerce-warranties-and-returns' ); ?></label>\
									<textarea class=\"option short\" name=\"wcwar_qp_desc[]\" placeholder=\"\" step=\"any\"></textarea>\
									<em><?php esc_html_e( 'Enter warranty descriptio.', 'woocommerce-warranties-and-returns' ); ?></em>\
								</p>\
								<p class=\"form-field wcwar_qp_thumb\">\
									<span class=\"thumb_preview\"></span>\
									<label for=\"wcwar_qp_thumb\"><?php  esc_html_e( 'Warranty thumbnail (optional)', 'woocommerce-warranties-and-returns' ); ?></label>\
		...
		<div id="wcwar_tab" class="form-field">
			...
			<div class="options_group grouping type" data-group="quick_warranty">
				<p class="form-field wcwar_q_type">
					<label for="wcwar_q_type"><?php esc_html_e( 'Select warranty type', 'woocommerce-warranties-and-returns' ); ?></label>
	...
	?>
		...
		<tr class="form-field wcwar-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Warranty', 'woocommerce-warranties-and-returns' ); ?></label></th>
			<td>
				<div id="wcwar_tab" class="form-field">
	...
	<?php
		...
		function war_admin_scripts( $hook ) {
			...
			if ( $hook == 'post.php' || $hook == 'edit.php' || $hook == 'post-new.php' ) {
				...
				$localize = array(
					...
					'localization' => array(
						'delete' => esc_html__( 'Delete?', 'woocommerce-warranties-and-returns' ),
						'notselected' => esc_html__( 'Not selected.', 'woocommerce-warranties-and-returns' ),
						'deleted' => esc_html__( 'Deleted!', 'woocommerce-warranties-and-returns' ),
						'error' => esc_html__( 'Error!', 'woocommerce-warranties-and-returns' ),
						'load' => esc_html__( 'Load?', 'woocommerce-warranties-and-returns' ),
						'loaded' => esc_html__( 'Loaded!', 'woocommerce-warranties-and-returns' ),
						'templatename' => esc_html__( 'Template name?', 'woocommerce-warranties-and-returns' ),
						'missing' => esc_html__( 'Missing email or name.', 'woocommerce-warranties-and-returns' ),
						'sendemail' => esc_html__( 'Send Email?', 'woocommerce-warranties-and-returns' ),
						'saved' => esc_html__( 'Saved!', 'woocommerce-warranties-and-returns' ),
						'emailsent' => esc_html__( 'Email sent!', 'woocommerce-warranties-and-returns' ),
					)
				);
			...
			if ( isset( $_GET['page'], $_GET['tab'] ) && $_GET['page'] == 'wc-settings' && $_GET['tab'] == 'warranties_and_returns' || isset( $_GET['page'] ) && $_GET['page'] == 'xforwoocommerce' ) {
				...
				wp_enqueue_script( 'wcwar-vendor', self::$url_path . 'lib/formbuilder/vendor/js/vendor.js', array( 'jquery', 'underscore' ), WC_Warranties_And_Returns::$version, true );
			...
			foreach ( $ids as $id ) {
				...
				?>
					<div class="war_warranty<?php echo esc_attr( $curr_class ); ?>" data-id="<?php echo esc_attr( $id ); ?>">
						<<?php echo esc_html( $title_tag ); ?>><?php esc_html_e( 'Included Warranty', 'woocommerce-warranties-and-returns' ); ?></<?php echo esc_html( $title_tag ); ?>>
						<p>
							...
							?>
								...
								<?php
									...
									esc_html_e( 'Lifetime Warranty', 'woocommerce-warranties-and-returns' );
								}
							?>
				...
				?>
					<div class="war_warranty war_paid<?php echo esc_attr( $curr_class ); ?>" data-id="<?php echo esc_attr( $id ); ?>">
						<<?php echo esc_html( $title_tag ); ?>><?php esc_html_e( 'Select Warranty Options', 'woocommerce-warranties-and-returns' ); ?></<?php echo esc_html( $title_tag ); ?>>
						<p>
						...
						<p class="war_option" data-selected="no_warranty">
							<strong><?php esc_html_e( 'Not selected', 'woocommerce-warranties-and-returns' ); ?></strong><br/>
						<small><?php esc_html_e( 'Purchase this product without any warranty options.', 'woocommerce-warranties-and-returns' ); ?></small>
						</p>
						<?php } ?>
						<?php for ( $i = 0; $i < count( (int) $curr_warranty['paid_warranty'] ); $i++ ) { ?>
		...
		function war_order( $order ) {
			...
			if ( sizeof( $order->get_items() ) > 0 ) {
				...
				<h2><?php esc_html_e( 'Available Warranties for this Order', 'woocommerce-warranties-and-returns' ); ?></h2>
				<?php
					if ( !in_array( $order->get_status(), apply_filters( 'wcwar_warranty_order_status', array( 'completed' ), $order ) ) ) {
				?>
				<p class="wcwar_status blue">
					<span class="wcwar_info_icon"><i class="wcwar-info"></i></span> <?php esc_html_e( 'Your warranties will be available once your order is complete.', 'woocommerce-warranties-and-returns' ); ?>
				</p>
				<?php
					$curr_complete = get_post_meta( $id, '_ordered_date', true );
					$warranty_status_hold[] = '<p class="wcwar_status blue"><span class="wcwar_info_icon"><i class="wcwar-info"></i></span>' . esc_html__( 'Pending order', 'woocommerce-warranties-and-returns' ) . '</p>';
				...
				<table class="shop_table wcwarranty">
					<thead>
						<tr>
							<th><?php esc_html_e( 'Product', 'woocommerce-warranties-and-returns' ); ?></th>
							<th><?php esc_html_e( 'Warranty', 'woocommerce-warranties-and-returns' ); ?></th>
							<th><?php esc_html_e( 'Status', 'woocommerce-warranties-and-returns' ); ?></th>
							<th><?php esc_html_e( 'Action', 'woocommerce-warranties-and-returns' ); ?></th>
						</tr>
					</thead>
					<tbody>
				<?php
					...
					<?php
							...
							foreach ( $curr_req as $req ) {
								...
								if ( $return !== '' && $return == 'return' ) {
									if ( !empty ( $curr_terms) && $curr_terms->slug == 'completed' ) {
										$curr_addon .= '<span class="wcwar_status grey"><span class="wcwar_info_icon"><i class="wcwar-cross"></i></span><span>' . esc_html__( 'This item has been returned to the store.', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '';
									}
									else if ( $req->post_status == 'pending' ) {
										$curr_addon .= '<span class="wcwar_status blue"><span class="wcwar_info_icon"><i class="wcwar-info"></i></span><span>' . esc_html__( 'Pending review', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '';
									}
									else if ( !empty ( $curr_terms) && $curr_terms->slug == 'rejected' ) {
										$curr_addon .= '<span class="wcwar_status grey"><span class="wcwar_info_icon"><i class="wcwar-cross"></i></span><span>' . esc_html__( 'Return rejected', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '<a href="' . get_permalink( $curr_reqId ) . '" class="wcwar_request_button button">' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '</a>';
									}
									else {
										$curr_addon .= '<span class="wcwar_status yellow"><span class="wcwar_info_icon"><i class="wcwar-info"></i></span><span>' . esc_html__( 'Return requested', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '<a href="' . get_permalink( $curr_reqId ) . '" class="wcwar_request_button button">' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '</a>';
									}
									$requested = true;
									...
									if ( !empty ( $curr_terms ) && $curr_terms->slug == 'completed' ) {
										$curr_addon .= '<span class="wcwar_status blue"><span class="wcwar_info_icon"><i class="wcwar-check"></i></span><span>' . esc_html__( 'Completed', 'woocommerce-warranties-and-returns' ) . $curr_numid . '</span></span>';
										$curr_link[] = '<a href="' . get_permalink( $curr_reqId ) . '" class="wcwar_request_button button">' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . $curr_numid . '</a>';
									}
									else if( !empty ( $curr_terms ) && $curr_terms->slug == 'rejected' ) {
										$curr_addon .= '<span class="wcwar_status grey"><span class="wcwar_info_icon"><i class="wcwar-cross"></i></span><span>' . esc_html__( 'Warranty rejected', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '<a href="' . get_permalink( $curr_reqId ) . '" class="wcwar_request_button button">' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . $curr_numid . '</a>';
									}
									else if ( !empty ( $curr_terms ) && $req->post_status !== 'pending' ) {
										$curr_addon .= '<span class="wcwar_status yellow"><span class="wcwar_info_icon"><i class="wcwar-info"></i></span><span>' . esc_html__( 'Requested', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '<a href="' . get_permalink( $curr_reqId ) . '" class="wcwar_request_button button">' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . $curr_numid . '</a>';
										$requested = true;
									}
									else {
						...
						if ( $curr_notallowed === false && $curr_status === 'nowar' && $curr_returns == 'yes' && empty( $curr_req ) ) {
							...
							$addon_msg = esc_html__( 'This item was sold without warranty', 'woocommerce-warranties-and-returns' );

							if ( self::hlp_valid_return( $curr_complete, $item ) === true ) {
								$addon_msg .= esc_html__( ', however you can still return it to the store', 'woocommerce-warranties-and-returns' );
								$warranty_status[] = '<p class="wcwar_status green"><span class="wcwar_info_icon"><i class="wcwar-check"></i></span>' . esc_html__( 'Return available', 'woocommerce-warranties-and-returns' ) . '</p>';
								$curr_link[] = '<a href="' . esc_url( $curr_request ) . '" class="wcwar_request_button button">' . esc_html__( 'Request Return', 'woocommerce-warranties-and-returns' ) . '</a>';
							}
							else {
								$warranty_status[] = '<p class="wcwar_status grey"><span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>' . esc_html__( 'No warranty', 'woocommerce-warranties-and-returns' ) . '</p>';
							}
							...
							$addon_msg = esc_html__( 'Warranty for this item has expired', 'woocommerce-warranties-and-returns' );
							$warranty_status[] = '<p class="wcwar_status grey"><span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>' . esc_html__( 'Expired', 'woocommerce-warranties-and-returns' ) . '</p>';
							$request_button = false;
						}
					...
					?>
								<span class="wcwar_block_wrap">
									...
									<span class="wcwar_warranty_period">
										<span>
											<?php echo esc_html__( 'Included Warranty', 'woocommerce-warranties-and-returns' ) . ' - ' . esc_html( $curr_warranty['included_warranty']['period'] ) . ' ' . self::hlp_get_warranty_string( $curr_warranty['included_warranty']['period'], $curr_warranty['included_warranty']['type'] ); ?>
										</span>
										<?php
								...
								<?php
									if ( $curr_notallowed === false && !isset( $warranty_status ) && $request_button === true ) {
										...
										$warranty_status[] = '<span class="wcwar_status green"><span class="wcwar_info_icon"><i class="wcwar-check"></i></span><span>' . esc_html__( 'Valid', 'woocommerce-warranties-and-returns' ) . '</span></span>';

									}
									else if ( $curr_notallowed === false && $requested === false && $curr_multi_req == 'yes' && $request_button === true ) {
										$warranty_status[] = '<span class="wcwar_status green"><span class="wcwar_info_icon"><i class="wcwar-check"></i></span><span>' . esc_html__( 'Valid', 'woocommerce-warranties-and-returns' ) . '</span></span>';
										$curr_link[] = '<a href="' . esc_url( $curr_request ) . '" class="wcwar_request_button button">' . esc_html__( 'Request Warranty', 'woocommerce-warranties-and-returns' ) . '</a>';
									}
							...
							?>
										<span class="wcwar_block_wrap">
											...
											<span class="wcwar_warranty_period">
												<span>
													<?php echo esc_html__( 'Paid Warranty', 'woocommerce-warranties-and-returns' ) . ' (+' . wc_price( $curr_warranty['paid_warranty'][$curr]['price'] ) . ')' . ' - ' . esc_html( $curr_warranty['paid_warranty'][$curr]['period'] ) . ' ' . self::hlp_get_warranty_string( $curr_warranty['paid_warranty'][$curr]['period'], $curr_warranty['paid_warranty'][$curr]['type'] ); ?>
												</span>
												<?php
										...
										esc_html_e( 'This item was sold without warranty', 'woocommerce-warranties-and-returns' );
									}
								}
							}
							else {
						...
						?>
							...
							<?php
								if ( $curr_notallowed === false && $request_button === true && !isset( $curr_link ) ) {
									echo '<a href="' . esc_url( $curr_request ) . '" class="wcwar_request_button button">' . esc_html__( 'Request Warranty', 'woocommerce-warranties-and-returns' ) . '</a>';
								}
								else {
		...
		function war_items_warranty_column_header() {
			echo '<th class="wcwar_warranty_item">' . esc_html__( 'Warranty Type', 'woocommerce-warranties-and-returns' ) . '</th>';
			echo '<th class="wcwar_warranty_status">' . esc_html__( 'Warranty Status', 'woocommerce-warranties-and-returns' ) . '</th>';
		}
		...
		function war_items_warranty_column( $curr_product, $curr_item, $curr_item_id ) {
			...
			if ( $curr_order !== false ) {
				...
				if ( $status && $status === 'nowar' ) {
					$curr_fields['warranty'] = esc_html__( 'No Warranty', 'woocommerce-warranties-and-returns' );
					$curr_fields['status'] = '<span class="wcwar_badge warranty_nowar">' . esc_html__( 'No Warranty', 'woocommerce-warranties-and-returns' ) . '</span>';
				}
				else if ( $status ) {
					$curr_fields['status'] = '<span class="wcwar_badge warranty_rejected">' . esc_html__( 'Warranty Expired', 'woocommerce-warranties-and-returns' ) . '</span>';
				}
				...
				if ( !empty( $curr_req) ) {
					...
					if ( !empty ( $curr_terms) ) {
						...
						if ( $return !== '' && $return == 'return' ) {
							$curr_fields['status'] = '<span class="wcwar_badge warranty_only">' . esc_html__( 'Return', 'woocommerce-warranties-and-returns' ) . '</span>';
						}
						else {
							$curr_fields['status'] = '<span class="wcwar_badge return_only">' . esc_html__( 'Warranty', 'woocommerce-warranties-and-returns' ) . '</span>';
						}

						$switch_slug = $curr_terms->slug;
						if ( $switch_slug == 'new' ) {
							$curr_fields['status'] .= '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_new" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'New', 'woocommerce-warranties-and-returns' ) . '</a>';
							$curr_fields['status'] .= '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button view_warranty" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
						else if ( $switch_slug == 'processing' ) {
							$curr_fields['status'] .= '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_processing" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'Processing', 'woocommerce-warranties-and-returns' ) . '</a>';
							$curr_fields['status'] .= '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button view_warranty" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
						else if ( $switch_slug == 'completed' ) {
							$curr_fields['status'] .= '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_completed" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'Completed', 'woocommerce-warranties-and-returns' ) . '</a>';
							$curr_fields['status'] .= '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button view_warranty" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
						else if ( $switch_slug == 'rejected' ) {
							$curr_fields['status'] .= '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_rejected" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'Rejected', 'woocommerce-warranties-and-returns' ) . '</a>';
							$curr_fields['status'] .= '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button view_warranty" title="' . esc_attr__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
					}
					$curr_fields['status'] .= '<a href="#" class="wcwar_badge warranty_button warranty_change_status" data-id="' . $curr_req[0]->ID . '" title="' . esc_attr__( 'Change Request Status', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-change"></i></a>';
				}
				...
				$admin_url = esc_url( admin_url( 'post-new.php?post_type=wcwar_warranty_req&order_id=' . esc_attr( $curr_order ) . esc_attr( $curr_parent ) . '&item_id=' . esc_attr( $curr_item_id ) ) . '&post_title=' . esc_html__( 'Request for Order', 'woocommerce-warranties-and-returns' ) . ' %23' . esc_attr( $curr_order ) . ' - ' . esc_html__( 'Item', 'woocommerce-warranties-and-returns' ) . ' %23' . esc_attr( $curr_item_id ) );

				if ( isset( $curr_warranty['quick'] ) && $curr_warranty['quick'] !== '' ) {
					$curr_new_set = false;
					if ( $curr_warranty['quick'] == 'included_warranty' && isset( $curr_warranty['included_warranty'] ) ) {
						$curr_fields['warranty'] = esc_html( $curr_warranty['included_warranty']['period'] ) . ' ' . self::hlp_get_warranty_string( $curr_warranty['included_warranty']['period'], $curr_warranty['included_warranty']['type'] ) . ' ' . esc_html__( 'included warranty', 'woocommerce-warranties-and-returns' );
						if ( !isset( $curr_fields['status'] ) ) {
							$curr_fields['status'] = '<a href="' . esc_url( $admin_url ) . '" class="wcwar_badge in_warranty" title="' . esc_html__( 'Create Warranty Request for this Item', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'In Warranty', 'woocommerce-warranties-and-returns' ) . '</a>';
							$curr_fields['status'] .= '<a href="' . esc_url( $admin_url ) . '" class="wcwar_badge warranty_button wcwar_create" data-ids="' . esc_attr( $curr_order ) . '|' . esc_attr( $curr_item_id ) . '" title="' . esc_html__( 'Create Warranty Request for this Item', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-new"></i></a>';
						}
					}
						...
						if ( $curr !== 'no_warranty' ) {
							...
							$curr_fields['warranty'] = esc_html( $curr_warranty['paid_warranty'][$curr]['period'] ) . ' ' . self::hlp_get_warranty_string( $curr_warranty['paid_warranty'][$curr]['period'], $curr_warranty['paid_warranty'][$curr]['type'] ) . ' ' . esc_html__( 'paid warranty', 'woocommerce-warranties-and-returns' ) . ' <small>(+ ' . wc_price( $curr_warranty['paid_warranty'][$curr]['price'] ) . ')</small>';
				...
				$curr_fields['warranty'] = esc_html__( 'Please refresh', 'woocommerce-warranties-and-returns' ); // OK
				$curr_fields['status'] = esc_html__( 'Please refresh', 'woocommerce-warranties-and-returns' ); // OK
			}
	?>
	...
	<?php
		...
		function war_request_warranty_column_header( $columns ) {
			...
			$columns['status'] = esc_html__( 'Request Status', 'woocommerce-warranties-and-returns' );
			return $columns;
		...
		function war_request_warranty_column( $column, $post_id ) {
			...
			if ( $column == 'status' ) {
				...
				if ( !empty( $curr_terms ) ) {
					...
					echo '<a href="' . get_permalink( $post_id ) . '" class="wcwar_badge warranty_button view_warranty" title="' . esc_html__( 'View Request Status', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
					echo '<a href="#" class="wcwar_badge warranty_button warranty_change_status" data-id="' . esc_attr( $post_id ) . '" title="' . esc_html__( 'Change Request Status', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-change"></i></a>';
					echo '</span>';
				}
		...
		function hlp_get_warranty_string( $n, $t ) {
			switch ( $t ) {
				case 'days' :
					$out = _n( 'Day', 'Days', $n, 'woocommerce-warranties-and-returns' );
				break;
				case 'weeks' :
					$out = _n( 'Week', 'Weeks', $n, 'woocommerce-warranties-and-returns' );
				break;
				case 'months' :
					$out = _n( 'Month', 'Months', $n, 'woocommerce-warranties-and-returns' );
				break;
				case 'years' :
					$out = _n( 'Year', 'Years', $n, 'woocommerce-warranties-and-returns' );
				break;
				case 'lifetime' :
					$out = esc_html__( 'Lifetime', 'woocommerce-warranties-and-returns' );
				break;
				default :
					$out = '';
				break;
		...
		function war_register_request_metabox() {
			add_meta_box(
				'war-request',
				esc_html__( 'Warranties and Returns - Request Details', 'woocommerce-warranties-and-returns' ),
		...
		function war_request_metabox( $object, $box ) {
			...
			if ( $object->post_parent !== '0' || $curr_item == '-1' ) {
				...
				$str_type = esc_html__( 'Multiple Item Order', 'woocommerce-warranties-and-returns' ); // OK
			}
			else {
				$curr_parent_order = $object->ID;
				$str_type = esc_html__( 'Single Item Order', 'woocommerce-warranties-and-returns' ); // OK
			}
		...
		<div id="woocommerce-order-items">
			<div class="war_warranty woocommerce_order_items_wrapper">
				...
				<p class="wcwar_warranty_details">
					<span class="wcwar_meta_order"><i class="wcwar-order"></i> <?php esc_html_e( 'Order ', 'woocommerce-warranties-and-returns' ); ?> #<?php echo absint( $curr_order ); ?> - <?php echo esc_html( $str_type ); ?><a href="<?php echo esc_url( admin_url( 'post.php?post=' . absint( $curr_order ) . '&action=edit' ) ); ?>" class="wcwar_badge warranty_button warranty_view_order" title="<?php esc_html_e( 'Manage Order', 'woocommerce-warranties-and-returns' ); ?>"><i class="wcwar-view"></i> <?php esc_html_e( 'Manage Order ', 'woocommerce-warranties-and-returns' ); ?></a></span>
				</p>
				<p class="wcwar_warranty_status">
					<span class="wcwar_badge_parent"><i class="wcwar-icon"></i> <?php echo ( isset( $parent ) ? esc_html__( 'Parent', 'woocommerce-warranties-and-returns' ) . ' ' : '' ) . esc_html__( 'Request Status', 'woocommerce-warranties-and-returns' ); ?>
					<?php
						...
						if ( !empty ( $curr_terms) ) {
							$switch_slug = $curr_terms->slug;
							if ( $switch_slug == 'new' ) {
								echo '<a href="' . esc_url( admin_url( 'post.php?post=' . absint( $curr_parent_order ) . '&action=edit' ) ) . '" class="wcwar_badge wcwar_change warranty_new">' . esc_html__( 'New', 'woocommerce-warranties-and-returns' ) . '</a>';
							}
							else if ( $switch_slug == 'processing' ) {
								echo '<a href="' . esc_url( admin_url( 'post.php?post=' . absint( $curr_parent_order ) . '&action=edit' ) ) . '" class="wcwar_badge wcwar_change warranty_processing">' . esc_html__( 'Processing', 'woocommerce-warranties-and-returns' ) . '</a>';
							}
							else if ( $switch_slug == 'completed' ) {
								echo '<a href="' . esc_url( admin_url( 'post.php?post=' . absint( $curr_parent_order ) . '&action=edit' ) ) . '" class="wcwar_badge wcwar_change warranty_completed">' . esc_html__( 'Completed', 'woocommerce-warranties-and-returns' ) . '</a>';
							}
							else if ( $switch_slug == 'rejected' ) {
								echo '<a href="' . esc_url( admin_url( 'post.php?post=' . absint( $curr_parent_order ) . '&action=edit' ) ) . '" class="wcwar_badge wcwar_change warranty_rejected">' . esc_html__( 'Rejected', 'woocommerce-warranties-and-returns' ) . '</a>';
							}
							if ( $curr_item !== '-1' ) {
								echo '<a href="' . esc_url( admin_url( 'post.php?post=' . absint( $curr_parent_order ) . '&action=edit' ) ) . '" class="wcwar_badge warranty_button" title="' . esc_html__( 'View Parent Request Status', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
							}
							echo '<a href="#" class="wcwar_badge warranty_button warranty_change_status" data-id="' . absint( $curr_parent_order ) . '" title="' . esc_html__( 'Change Request Status', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-change"></i></a>';
						}
					?>
					</span>
				</p>
				<p class="wcwar_email">
					<?php esc_html_e( 'Send a quick E-Mail the Customer', 'woocommerce-warranties-and-returns' ); ?> : 
					...
					<span class="wcwar_badge wcwar_label"><?php esc_html_e( 'Email Template', 'woocommerce-warranties-and-returns' ); ?></span>
					<select class="war_email_selected">
						<option value=""><?php esc_html_e( 'None', 'woocommerce-warranties-and-returns' ); ?></option>
						<?php
					...
					<a href="#" class="wcwar_badge war_load"><?php esc_html_e( 'Load', 'woocommerce-warranties-and-returns' ); ?></a>
					<a href="#" class="wcwar_badge war_save"><?php esc_html_e( 'Save', 'woocommerce-warranties-and-returns' ); ?></a>
					<a href="#" class="wcwar_badge war_delete"><?php esc_html_e( 'Delete Selected', 'woocommerce-warranties-and-returns' ); ?></a>
					<a href="#" class="wcwar_badge war_send" data-ids="<?php echo esc_attr( $curr_order ) . '|' . esc_attr( $object->ID );?>"><?php esc_html_e( 'Send Email', 'woocommerce-warranties-and-returns' ); ?></a>
				</p>
				<p style="display:none">
					<label for="_wcwar_warranty_status">
					<?php esc_html_e( 'Change Request Status', 'woocommerce-warranties-and-returns' ); ?> : 
					<?php
				...
				<p style="display:none">
					<label for="_wcwar_warranty_order_id">
						<?php esc_html_e( 'Order ID', 'woocommerce-warranties-and-returns' ); ?> : 
						<input name="_wcwar_warranty_order_id" value="<?php echo esc_attr( $curr_order ); ?>" />
					</label>
				</p>
				<p style="display:none">
					<label for="_wcwar_warranty_product_id">
						<?php esc_html_e( 'Item ID', 'woocommerce-warranties-and-returns' ); ?> : 
				...
				<p style="display:none">
					<label for="parent_id">
						<?php esc_html_e( 'Parent ID', 'woocommerce-warranties-and-returns' ); ?> : 
				...
				<table cellpadding="0" cellspacing="0" class="woocommerce_order_items">
					<thead>
						<tr>
							<th class="item" colspan="2"><?php esc_html_e( 'Item', 'woocommerce-warranties-and-returns' ); ?></th>

							<?php do_action( 'woocommerce_admin_order_item_headers' ); ?>

							<th class="quantity"><?php esc_html_e( 'Qty', 'woocommerce-warranties-and-returns' ); ?></th>

							<th class="line_cost"><?php esc_html_e( 'Total', 'woocommerce-warranties-and-returns' ); ?></th>
						...
						<td class="thumb">
							...
							?>
								...
								<?php
									...
									echo '<strong>' . esc_html__( 'Product ID:', 'woocommerce-warranties-and-returns' ) . '</strong> ' . absint( $item['product_id'] );

									if ( $item['variation_id'] && 'product_variation' === get_post_type( $item['variation_id'] ) ) {
										echo '<br/><strong>' . esc_html__( 'Variation ID:', 'woocommerce-warranties-and-returns' ) . '</strong> ' . absint( $item['variation_id'] );
									} elseif ( $item['variation_id'] ) {
										echo '<br/><strong>' . esc_html__( 'Variation ID:', 'woocommerce-warranties-and-returns' ) . '</strong> ' . absint( $item['variation_id'] ) . ' (' . esc_html__( 'No longer exists', 'woocommerce-warranties-and-returns' ) . ')';
									}

									if ( $_product && $_product->get_sku() ) {
										echo '<br/><strong>' . esc_html__( 'Product SKU:', 'woocommerce-warranties-and-returns' ).'</strong> ' . esc_html( $_product->get_sku() );
									}
						...
						<td class="name">
							...
							<div class="edit" style="display: none;">
								<table class="meta" cellspacing="0">
									...
									<tfoot>
										<tr>
											<td colspan="4"><button class="add_order_item_meta button"><?php esc_html_e( 'Add&nbsp;meta', 'woocommerce-warranties-and-returns' ); ?></button></td>
										</tr>
									</tfoot>
								</table>
							</div>
						...
						<td class="line_cost" width="1%">
							...
							<div class="edit" style="display: none;">
								<div class="split-input">
									...
									<input type="text" name="line_total[<?php echo absint( $item_id ); ?>]" placeholder="<?php echo wc_format_localized_price( 0 ); ?>" value="<?php echo esc_attr( $item_total ); ?>" class="line_total wc_input_price tips" data-tip="<?php esc_html_e( 'After pre-tax discounts.', 'woocommerce-warranties-and-returns' ); ?>" data-total="<?php echo esc_attr( $item_total ); ?>" />
	...
	?>
		<div id="woocommerce-order-items">
			<div class="war_warranty woocommerce_order_items_wrapper">
				...
				<p>
					<label for="_wcwar_warranty_order_id">
						<?php esc_html_e( 'Please enter Order ID', 'woocommerce-warranties-and-returns' ); ?> : 
						<input name="_wcwar_warranty_order_id" value="<?php echo esc_attr( $curr_order ); ?>" />
					</label>
				</p>
			</div>
	...
	<?php
		...
		function war_ajax_email_send() {
			...
			if ( !empty( $order ) ) {
				...
				$curr_subject = esc_html__( 'Warranty Request for order #', 'woocommerce-warranties-and-returns' ) . $id . ' - ' . get_bloginfo('name' );
				...
				if ( count( $curr_ordered) > 1 ) {
					...
					if ( empty( $curr_parent_req) ) {
						...
						$curr_parent_create = array(
							'post_title'    => esc_html__( 'Request for Order #', 'woocommerce-warranties-and-returns' ) . $id,
							'post_content'  => esc_html__( 'This is a parent warranty request. Check child requests for details.', 'woocommerce-warranties-and-returns' ),
							'post_name'     => 'r_' . $id,
					...
					$curr_create = array(
						'post_title'    => esc_html__( 'Request for Order #', 'woocommerce-warranties-and-returns' ) . $order . ' - ' . esc_html__( 'Item #', 'woocommerce-warranties-and-returns' ) . $item_id,
						'post_content'  => '',
					...
					$curr_create = array(
						'post_title'    => esc_html__( 'Request for Order #', 'woocommerce-warranties-and-returns' ) . $id . ' - ' . esc_html__( 'Item #', 'woocommerce-warranties-and-returns' ) . $item_id,
						'post_content'  => '',
		...
		<?php
			...
			$id = method_exists( $curr_order, 'get_id' ) ? $curr_order->get_id() : $curr_order->ID;
				...
				if ( count( $curr_items) > 1 ) {
					...
					esc_html_e( 'Warranty Status (Multi Item Order):', 'woocommerce-warranties-and-returns' );
				}
				else {
					$curr_args = array(
						'post_type' => 'wcwar_warranty_req',
					...
					esc_html_e( 'Warranty Status (Single Item Order):', 'woocommerce-warranties-and-returns' );
				}
				echo '<br/>';
				...
				if ( !empty( $curr_req ) ) {
					...
					if ( !empty ( $curr_terms) ) {
						$switch_slug = $curr_terms->slug;
						if ( $switch_slug == 'new' ) {
							echo '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_new" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'New', 'woocommerce-warranties-and-returns' ) . '</a>';
							echo'<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
						else if ( $switch_slug == 'processing' ) {
							echo '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_processing" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'Processing', 'woocommerce-warranties-and-returns' ) . '</a>';
							echo '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
						else if ( $switch_slug == 'completed' ) {
							echo '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_completed" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'Completed', 'woocommerce-warranties-and-returns' ) . '</a>';
							echo '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
						else if ( $switch_slug == 'rejected' ) {
							$curr_fields['status'] = '<a href="' . esc_url( $curr_req[0]->guid ) . '" class="wcwar_badge wcwar_change warranty_rejected" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '">' . esc_html__( 'Rejected', 'woocommerce-warranties-and-returns' ) . '</a>';
							echo '<a href="' . get_edit_post_link( $curr_req[0]->ID ) . '" class="wcwar_badge warranty_button" title="' . esc_html__( 'View Request', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-view"></i></a>';
						}
					}
					echo '<a href="#" class="wcwar_badge warranty_button warranty_change_status" data-id="' . esc_attr( $curr_req[0]->ID ) . '" title="' . esc_html__( 'Change Request Status', 'woocommerce-warranties-and-returns' ) . '"><i class="wcwar-change"></i></a>';
				}
				else {
					echo '<span class="wcwar_badge warranty_notrequested" >' . esc_html__( 'This order has no warranty requests', 'woocommerce-warranties-and-returns' ) . '</span>';
				}
				...
				if ( !isset( $_POST['wcwar_return'] ) ) {
					...
					if ( $curr_multi_req == 'no' ) {
						...
						?>
							...
							<?php
								echo esc_html__( 'Warranty already requested. View request status on this', 'woocommerce-warranties-and-returns' ) . ' <a href="' . esc_url( $curr_req[0]->guid ) . '">' . esc_html__( 'link', 'woocommerce-warranties-and-returns' ) . '</a>.';
							?>
							</p>
						<?php
							$output = ob_get_clean();
					...
					if ( isset( $_POST['wcwar_qty'] ) ) {
						$request_content .= '<strong>' . esc_html__( 'Item was ordered multiple times, the requested number of item warranties is: ', 'woocommerce-warranties-and-returns' ) . intval( $_POST['wcwar_qty'] ) . '</strong>
';
					}
							...
							case 'checkboxes' :
								...
								foreach ( $cfld['field_options']['options'] as $cf ) {
									if ( isset( $_POST['wcwar_' . $cfld['cid'] . '_' . $i] ) ) {
										$request_content .= esc_html( $cf['label'] ) . ' : ' . esc_html__( 'Checked', 'woocommerce-warranties-and-returns' ) . '
										';
									}
									$i++;
								}
...
';
					...
					$request_content = '';
					if ( isset( $_POST['wcwar_qty'] ) ) {
						$request_content .= '<strong>' . esc_html__( 'Item was ordered multiple times, the requested number of item returns is: ', 'woocommerce-warranties-and-returns' ) . intval( $_POST['wcwar_qty'] ) . '</strong>' . '
';
					}
					$request_content .= esc_html__( 'Nothing is wrong with the item. Customer just does not like it. Return was requested for this item.', 'woocommerce-warranties-and-returns' ) . '
';
					if ( isset( $_POST['wcwar_return_note'] ) ) {
						$request_content .= esc_html__( 'Return message from the buyer:', 'woocommerce-warranties-and-returns' ) . '
';
...
';
				...
				if ( $has_error === false ) {
					...
					if ( count( $curr_ordered ) > 1 ) {
						...
						?>
							<div class="wcwar_warranty">
								<p class="wcwar_form_error">
									<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>
									<?php esc_html_e( 'There is no warranty or return policy for this item.', 'woocommerce-warranties-and-returns' ); ?>
								</p>
							</div>
						<?php
							$output = ob_get_clean();
						...
						?>
							<div class="wcwar_warranty">
								<p class="wcwar_form_error">
									<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>
									<?php esc_html_e( 'There is no warranty for this item.', 'woocommerce-warranties-and-returns' ); ?>
								</p>
							</div>
						<?php
							$output = ob_get_clean();
						...
						?>
							<div class="wcwar_warranty">
								<p class="wcwar_form_error">
									<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>
									<?php esc_html_e( 'Warranty for this item has expired.', 'woocommerce-warranties-and-returns' ); ?>
								</p>
							</div>
						<?php
							$output = ob_get_clean();
						...
						?>
							<div class="wcwar_warranty">
								...
								<?php
									if ( !empty( $curr_terms ) && $curr_terms->slug == 'completed' ) {
										echo esc_html__( 'This item has already been returned to the store.', 'woocommerce-warranties-and-returns' );
									}
									else if ( $curr_req[$return_id]->post_status == 'pending' ) {
										echo esc_html__( 'Return already requested but is still pending review. Please be patient.', 'woocommerce-warranties-and-returns' ) . '<br/>';
									}
									else {
										echo esc_html__( 'Return already requested. View request status on this', 'woocommerce-warranties-and-returns' ) . ' <a href="' . get_permalink( $curr_req[$return_id]->ID ) . '">' . esc_html__( 'link', 'woocommerce-warranties-and-returns' ) . '</a>.<br/>';
									}
								?>
								</p>
							</div>
						...
						?>
							<div class="wcwar_warranty">
								<p class="wcwar_form_error">
									<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span><?php echo esc_html__( 'Warranty already requested. View request status on this', 'woocommerce-warranties-and-returns' ) . ' <a href="' . esc_url( $curr_req[0]->guid ) . '">' . esc_html__( 'link', 'woocommerce-warranties-and-returns' ) . '</a>.'; ?>
								</p>
							</div>
						<?php
							$output = ob_get_clean();
							...
							?>
								<div class="wcwar_warranty">
									<p class="wcwar_form_error">
										<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span><?php echo esc_html__( 'Warranty already requested. View request status on this', 'woocommerce-warranties-and-returns' ) . ' <a href="' . esc_url( $curr_req_reverse[0]->guid ) . '">' . esc_html__( 'link', 'woocommerce-warranties-and-returns' ) . '</a>.'; ?>
									</p>
								</div>
							<?php
								$output = ob_get_clean();
						...
						if ( empty( $curr_parent_req ) ) {
							...
							$curr_parent_create = array(
								'post_title'    => esc_html__( 'Request for Order #', 'woocommerce-warranties-and-returns' ) . absint( $_POST['order_id'] ),
								'post_content'  => esc_html__( 'This is a parent warranty request. Check child requests for details.', 'woocommerce-warranties-and-returns' ),
						...
						?>
							<div class="wcwar_warranty">
								<p class="wcwar_form_error">
									<?php echo esc_html( $item['name'] ) . ' ' . esc_html__( 'warranty has expired.', 'woocommerce-warranties-and-returns' ); ?>
								</p>
							</div>
						<?php
							$output = ob_get_clean();
						...
						$curr_create = array(
							'post_title'    => esc_html__( 'Request for Order #', 'woocommerce-warranties-and-returns' ) . absint( $_POST['order_id'] ) . ' - ' . esc_html__( 'Item #', 'woocommerce-warranties-and-returns' ) . esc_sql( $_POST['item_id'] ),
						...
						if ( isset( $_POST['wcwar_return'] ) ) {
							...
							?>
								<div class="wcwar_warranty">
									<p class="wcwar_form_error">
									<span class="wcwar_info_icon"><i class="wcwar-info"></i></span>
										<?php echo esc_html( $item['name'] ) . ' ' . esc_html__( 'return period has expired.', 'woocommerce-warranties-and-returns' ); ?>
									</p>
								</div>
							<?php
								$output = ob_get_clean();
						...
						$curr_create = array(
							'post_title'    => esc_html__( 'Request for Order #', 'woocommerce-warranties-and-returns' ) . absint( $_POST['order_id'] ) . ' - ' . esc_html__( 'Item #', 'woocommerce-warranties-and-returns' ) . absint( $_POST['item_id'] ),
							'post_content'  => $request_content,
					...
					?>
						<div class="wcwar_warranty">
							<p class="wcwar_form_success">
								<span class="wcwar_info_icon"><i class="wcwar-check"></i></span><?php esc_html_e( 'Return request accepted. Go back to your order', 'woocommerce-warranties-and-returns' ); ?> <a href="<?php echo esc_url( $order->get_view_order_url() ); ?>"><?php esc_html_e( 'here', 'woocommerce-warranties-and-returns' ); ?></a>!
							</p>
						</div>
					<?php
					}
					...
					?>
						<div class="wcwar_warranty">
							<p class="wcwar_form_success">
								<span class="wcwar_info_icon"><i class="wcwar-check"></i></span><?php esc_html_e( 'Warranty request accepted. Go back to your order', 'woocommerce-warranties-and-returns' ); ?> <a href="<?php echo esc_url( $order->get_view_order_url() ); ?>"><?php esc_html_e( 'here', 'woocommerce-warranties-and-returns' ); ?></a>!
							</p>
						</div>
					<?php
					}
				...
				if ( is_user_logged_in() || isset( $guest_request ) ) {
					...
					?>
						<p class="wcwar_form_info">
							<span class="wcwar_info_icon"><i class="wcwar-info"></i></span>
					<?php
							echo esc_html__( 'Product is not selected. Please visit your account page at this', 'woocommerce-warranties-and-returns' ) . ' <a href="' . get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) . '">' . esc_html__( 'link', 'woocommerce-warranties-and-returns' ) . '</a>.';
					?>
						</p>
					<?php
						$output = ob_get_clean();
					...
					if ( $_GET['item_id'] == '-1' ) {
						...
						$form_out = '<p class="wcwar_item wcwar_return"><strong>' . esc_html__( 'Select item', 'woocommerce-warranties-and-returns' ) . '</strong>';
						...
						?>
							<p class="wcwar_form_error">
								<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>
								<?php esc_html_e( 'There is no valid warranty for any of the ordered items.', 'woocommerce-warranties-and-returns' ); ?>
							</p>
						<?php
							$output = ob_get_clean();
							return $output;
						...
						?>
							<p class="wcwar_form_info">
								<span class="wcwar_info_icon"><i class="wcwar-info"></i></span>
								<?php echo esc_html__( 'There is no warranty for this item.', 'woocommerce-warranties-and-returns' ) . ' ' . esc_html__( 'However you can still return it to the store as its return warranty is still valid.', 'woocommerce-warranties-and-returns' ); ?>
							</p>
						<?php
							$only_return = true;
						}
						...
						<div class="wcwar_warranty">
							...
							<?php
								if ( self::hlp_valid_return( $curr_complete, $item ) === true ) {
									...
									echo esc_html__( 'However you can still return it to the store as its return warranty is still valid.', 'woocommerce-warranties-and-returns' );
									$only_return = true;
								}
							?>
						</p>
					...
					if ( isset( $_GET['multiple'] ) && $_GET['multiple'] == '1' ) {
						...
						$form_out .= '<p class="wcwar_item wcwar_multiple"><strong>' . esc_html__( 'Select Quantity', 'woocommerce-warranties-and-returns' ) . '</strong><label for="wcwar_qty">';
						$form_out .= '<input id="wcwar_qty" name="wcwar_qty" type="number" min="1" max="' . esc_attr( $item['qty'] ) . '" value="1" />';
						$form_out .= '</label>';
						$form_out .= '<small>' . sprintf( esc_html__( 'Total number of items ordered is %1$s. Please select how many items will be included in your warranty request.', 'woocommerce-warranties-and-returns' ), esc_attr( $item['qty'] ) ) . '</small>';
						$form_out .= '</p>';
					}

				?>
					<div class="wcwar_warranty woocommerce">
						<h2><?php printf( esc_html__( 'Order #%s', 'woocommerce-warranties-and-returns' ), $order->get_order_number() ); ?> - <?php echo esc_html( $item['name'] ); ?></h2>
						<form action="<?php the_permalink(); ?>" method="POST">
							<p class="order-info">
							<?php
								printf(
									esc_html__( 'Order #%s was placed on %s and is currently %s. To request a warranty for %s please fill in the form below.', 'woocommerce-warranties-and-returns' ),
						...
						?>
							<p class="wcwar_form_error">
								<span class="wcwar_info_icon"><i class="wcwar-info"></i></span><?php esc_html_e( 'Please fill in the required fields.', 'woocommerce-warranties-and-returns' ); ?>
							</p>
						<?php
						}
					...
					?>
						<p class="wcwar_return">
							<strong><?php esc_html_e( 'Return is still available', 'woocommerce-warranties-and-returns' ); ?></strong>
							<label for="wcwar_return">
								<input type="checkbox" id="wcwar_return" name="wcwar_return" /> <?php esc_html_e( 'Return item', 'woocommerce-warranties-and-returns' ); ?>
							</label><br/>
							<small><?php esc_html_e( 'Item returns are available in this shop. If you just want to return an item to the store please check this option.', 'woocommerce-warranties-and-returns' ); ?></small>
						</p>
						<p class="wcwar_return_note">
							<strong><?php esc_html_e( 'Why are you returning this item?', 'woocommerce-warranties-and-returns' ); ?></strong>
							<label for="wcwar_return_note">
								<textarea name="wcwar_return_note"></textarea>
							</label>
							<small><?php esc_html_e( 'Enter additional information for this return request.', 'woocommerce-warranties-and-returns' ); ?></small>
						</p>
					<?php
						}
						...
						foreach ( $curr_fields['fields'] as $cfld ) {
							if ( $cfld['required'] === true ) {
								$req = '<span class="wcwar_required">' . esc_html__( 'Required', 'woocommerce-warranties-and-returns' ) . '</span>'; // OK
							}
							else $req = '';
					?>
						...
						?>
							<label for="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_address" class="double"><?php esc_html_e( 'Address', 'woocommerce-warranties-and-returns' ); ?>
								<input type="text" id="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_address" name="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_address" />
							</label>
							<label for="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_city" class="single"><?php esc_html_e( 'City', 'woocommerce-warranties-and-returns' ); ?>
								<input type="text" id="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_city" name="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_city" />
							</label>
							<label for="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_zip" class="single"><?php esc_html_e( 'Zipcode', 'woocommerce-warranties-and-returns' ); ?>
								<input type="text" id="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_zip" name="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_zip" />
							</label>
							<label for="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_state" class="single"><?php esc_html_e( 'State / Province / Region', 'woocommerce-warranties-and-returns' ); ?>
								<input type="text" id="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_state" name="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_state" />
							</label>
							<label for="wcwar_<?php echo esc_attr( $cfld['cid'] ); ?>_country" class="single"><?php esc_html_e( 'Country', 'woocommerce-warranties-and-returns' ); ?>
					...
					?>
						...
						?>
							...
							<input value="<?php esc_html_e( 'Submit Request', 'woocommerce-warranties-and-returns' ); ?>" type="submit" class="button" />
						</p>
						</form>
					</div>
				<?php
					...
					?>
						<div class="wcwar_warranty">
							<p class="wcwar_form_error">
								<span class="wcwar_info_icon"><i class="wcwar-cross"></i></span>
								<?php esc_html_e( 'You cannot make this request.', 'woocommerce-warranties-and-returns' ); ?>
							</p>
						</div>
					<?php
					}
			...
			?>
				<div class="wcwar_warranty woocommerce">
					<form action="<?php the_permalink(); ?>" method="POST">
					<p class="wcwar_form_info">
						<span class="wcwar_info_icon"><i class="wcwar-info"></i></span> <?php esc_html_e( 'Warranty requests for users that are not logged in are allowed. Please fill in the form below to request a warranty for you order.', 'woocommerce-warranties-and-returns' ); ?>
					</p>
					<p>
			...
			<?php
				...
				?>
					<div class="wcwar_warranty">
						<p class="wcwar_form_error">
							<strong><?php esc_html_e( 'Guest warranty requests are not allowed!', 'woocommerce-warranties-and-returns' ); ?></strong>
	...
	<?php
		...
		function war_email( $order, $sent_to_admin, $plain_text ) {
			...
			<h3><?php esc_html_e( 'Available Warranties for this Order', 'woocommerce-warranties-and-returns' ); ?></h3>
			<?php
				if ( !in_array( $order->get_status(), apply_filters( 'wcwar_warranty_order_status', array( 'completed' ), $order ) ) ) {
			?>
			<p>
				<?php esc_html_e( 'Your warranties will be available once your order is complete.', 'woocommerce-warranties-and-returns' ); ?>
			</p>
			<?php
				$curr_complete = get_post_meta( $id, '_ordered_date', true );
				...
				<?php
					...
					if ( isset( $curr_warranty['quick'] ) && $curr_warranty['quick'] !== '' ) {
						if ( $curr_warranty['quick'] == 'included_warranty' && isset( $curr_warranty['included_warranty'] ) ) {
					?>
							<h3><?php echo '#' . $i . ' ' . esc_html( $item['name'] ) . ' ' . esc_html__( 'Warranty', 'woocommerce-warranties-and-returns' ) . ' - ' . esc_html__( 'Included Warranty', 'woocommerce-warranties-and-returns' ); ?></h3>
							<p>
								<?php if ( isset( $curr_warranty['included_warranty']['thumb'] ) ) { ?>
									<img width="64" height="auto" src="<?php echo esc_url( $curr_warranty['included_warranty']['thumb'] ); ?>" />
								<?php } ?>
								...
								<?php
									if ( $curr_notallowed === false ) {
										...
										echo esc_html( $item['name'] ) . ' ' . esc_html__( 'warranty is still valid. Request your warranty at this', 'woocommerce-warranties-and-returns' ) . ' ' . '<a href="' . esc_url( $curr_request ) . '" class="wcwar_request">' . esc_html__( 'link', 'woocommerce-warranties-and-returns' ) . '</a>.';
									}
								?>
							</p>
					<?php
		...
		function war_cart_help() {
			if ( isset( self::$settings['add_msg'] ) ) {
				printf( '
					...
					</tr>', esc_html__( 'Your purchase has included paid warranties!', 'woocommerce-warranties-and-returns' ) );
			}
		}
	...
	function svx_warranties_and_returns_add_plugin( $plugins ) {
		$plugins['warranties_and_returns'] = array(
			...
			'name' => esc_html__( 'Warranties and Returns', 'woocommerce-warranties-and-returns' )
		);
		return $plugins;
	}
